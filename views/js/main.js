...
function updatePositions() {
  //frame variable is defined here
  frame++;
  ...
  if (frame % 10 === 0) {
    ...
    //It seems like "frame++" "window.performance.mark" "window.performance.measure" are all for logAverageFrame.
    //Since log does not show on screen, I could just take it out. But it does not slow the performance so I left it here.
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < 80; i++) {
    ...
    //basicLeft variable is created and defined here, and due to DMContentLoaded, it is loaded before updatePositions function.
    //Also, basicLeft takes i (btwn 0-200) and the result that is is devide by cols is (btwn 0-7) and I am guessing if it multiplies by 256 max number will be similar to screen width.
    elem.basicLeft = (i % cols) * s;

    //Style.left paints horizontally spread out pizzas before scroll happens. Withous this, it creates one straigh line of pizza in the middle.
    elem.style.left = elem.basicLeft + 100 + 'px';
